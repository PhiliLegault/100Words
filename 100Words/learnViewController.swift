...
class learnViewController: UIViewController {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        allWords.shuffle()
        chineseCharacterButton.setTitle(allWords[count][0], for: .normal)
    ...
    @IBAction func characterToSpeech(_ sender: Any) {
        let utterance = AVSpeechUtterance(string: (chineseCharacterButton.titleLabel?.text!)!)
